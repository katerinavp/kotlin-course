...
val v19: Float = 5.75f
// апострофы не те для char, либо без апострофов, но будет Double
//val v20: Char = `1.414`
...
// в ковычках может быть только string, ковычки здесь не те
//val v32: String = “🤯”
val myEmojiString: String = "🤯"
val v33: Map<String, Int> = mapOf("true" to 2, "false" to 34)
// апострофы не те для char
//val v34: Char = ‘65535’
